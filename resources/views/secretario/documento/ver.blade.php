    ...
    <div id="main_area">
        <div class="row">
            <div class="col-xs-12" id="slider">
                    ...
                    <div class="row">
                        ...
                        <div id="slide-content" style="display: none;">
                            @for($i=0;$i<count($planillas);$i++)
                                ...
                                <h3>{{$planillas[$i]->nombre}}
                                    <p class="sub-text">{{$planillas[$i]->created_at}}</p>
                                    </h3>
                                </div>
                            @endfor
                        </div>
                ...
                @else
                    <h3 class="alert alert-danger">No Hay Documentos Disponibles</h3>
                @endif
            </div>
        </div>
        <br>
        <div class="row">
            <div class="col-md-8">
                {!! Form::open(['url'=>'verdocumento','method'=>'get','role'=>'form']) !!}
